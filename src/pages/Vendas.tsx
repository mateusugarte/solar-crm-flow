        ...
        <main className="flex-1 overflow-auto">
          ...
          <div className="p-6 space-y-6 animate-fade-in">
            ...
            <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
              ...
              <CardContent>
                <Button 
                  className="w-full md:w-auto gradient-solar text-primary-foreground font-semibold"
                ...
                {loading ? (
                  ...
                  <div className="space-y-3">
                    {leads
                      ...
                      .slice(0, 10)
                      .map(lead => (
                        <div key={lead.id} className="flex items-center justify-between p-4 rounded-lg bg-muted/30 border border-border/50">
                          <div>
